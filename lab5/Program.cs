...
class Program
{
    ...
    static void WriteUserInputToFile()
    {
        ...
        Console.WriteLine("Podaj po kolei teksty (wpisz 'STOP' aby zakończyć):");
    ...
    {
        string filePath = "dane.txt";
        Console.WriteLine("Podaj tekst do dopisania (STOP aby zakończyć):");
    ...
    // -------------------------------
    // ZADANIE 11 — CSV + średnie wartości
    // -------------------------------
